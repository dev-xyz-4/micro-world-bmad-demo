...
Create:
- <feature-root>/p1-non-main-switch-existing-branch/01-break.md
...
- make explicit the smallest first implementation target: add one bounded switch-existing option from an already-safe non-`main` branch without broadening into generalized Git workflow orchestration
