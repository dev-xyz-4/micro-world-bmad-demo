...
Create:
- <feature-root>/p1-branch-create-or-switch/01-break.md
...
- make explicit the smallest first implementation target: perform bounded branch creation and/or switching needed to leave unsafe `main` execution context without broadening into generalized Git workflow orchestration
